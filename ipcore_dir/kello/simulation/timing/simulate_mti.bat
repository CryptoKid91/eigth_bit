...
vlog -work work kello_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax kello_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.kello_tb work.glbl
