...
xst -ifn xst.scr
move kello_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\kello_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc kello_exdes.ucf kello_exdes

echo 'Running map'
map -timing -pr b kello_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm kello_exdes -w routed.ncd routed.v
cd ..
